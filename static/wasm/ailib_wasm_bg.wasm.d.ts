...
export const ailib_invoke: (a: number, b: number) => [number, number, number, number];
...
export const parseresult_cache_creation_tokens: (a: number) => bigint;
export const parseresult_cache_read_tokens: (a: number) => bigint;
...
export const parseresult_reasoning_tokens: (a: number) => bigint;
